...
public class NetLogin {
	...
	public NetLogin(final SuccessCallback successCallback, final FailCallback failCallback, String username,
			String password){
		...
		}, MainConfig.LOGIN_URL, HttpMethod.POST, "username",username,"password",password);
	}
